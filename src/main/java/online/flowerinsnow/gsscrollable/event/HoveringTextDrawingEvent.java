...
public class HoveringTextDrawingEvent extends Event {
    ...
    protected HoveringTextDrawingEvent(ItemStack stack, List<String> textLines, int mouseX, int mouseY, int screenWidth, int screenHeight, int maxTextWidth, FontRenderer font) {
        this.stack = stack;
